...
- `love.csv` — public CSV extract (8,280 rows)
- `love.json` — public JSON extract (8,280 rows)
...
> Unique Domains. *Available .LOVE One-Word Domains*. Version 2026-04-12. Public GitHub extract for the exact Unique Domains search represented by this repository.
